  ...
  return createPortal(
    ...
    <div
      style={{
        ...
        right: "16px",
        zIndex: 9999,
        pointerEvents: "none" /* Evita que el div invisible bloquee clics en la web */
      }}
    >
      {/* El botón real dentro del div con su animación de entrada y de latido */}
      <a
        href={url}
        target="_blank"
        rel="noreferrer"
        className={`rounded-full bg-green-500 font-bold text-white shadow-2xl flex items-center justify-center gap-2 whitespace-nowrap transition-all duration-300 hover:scale-105 hover:bg-green-400 select-none active:scale-95 ${
          animar ? "opacity-100 scale-100" : "opacity-0 scale-75"
        }`}
        style={{
          pointerEvents: "auto", /* Devuelve los clics únicamente al botón */
          height: "46px",
          paddingLeft: "20px",
          paddingRight: "20px",
          fontSize: "14px",
