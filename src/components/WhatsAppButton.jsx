...
export function WhatsAppButton() {
  ...
  return createPortal(
    <a
      ...
      target="_blank"
      rel="noreferrer"
      // Se añade relative para el pulso, animate-pulse sutil de fondo y transiciones optimizadas
      className={`z-50 rounded-full bg-green-500 px-5 py-3 text-sm font-bold text-white shadow-2xl flex items-center justify-center gap-2 whitespace-nowrap shrink-0 transition-all duration-300 before:content-[''] before:absolute before:inset-0 before:rounded-full before:bg-green-500 before:animate-ping before:opacity-20 before:-z-10 ${
        animar 
    ...
    >
      ...
      <span className="leading-none select-none">WhatsApp</span>
    </a>,
    document.body
  );
}
